...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname MachineLearning) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; A Pixel is a [0-255]
